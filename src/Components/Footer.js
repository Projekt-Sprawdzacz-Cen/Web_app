    ...
    return (
            <footer className="text-center">
				...
				<div className="container p-4 pb-0 d-flex justify-content-center">
					...
					<section className="m-2">	
                        <a className='footer-twitter-color' href="#!">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                            className="bi bi-twitter" viewBox="0 0 16 16">
                                ...
                                6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288
                                0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588
					...
					<section className="m-2">
                        <a className="footer-google-color" href="#!">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                            className="bi bi-google" viewBox="0 0 16 16">
                                <path d="M15.545 6.558a9.42 9.42 0 0 1 .139 1.626c0 2.434-.87 4.492-2.384 5.885h.002C11.978 15.292 10.158
                                16 8 16A8 8 0 1 1 8 0a7.689 7.689 0 0 1 5.352 2.082l-2.284 2.284A4.347 4.347 0 0 0 8 3.166c-2.087 0-3.86
					...
					<section className="m-2">
                        <a className="footer-instagram-color" href="#!">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                            className="bi bi-instagram" viewBox="0 0 16 16">
                                ...
                                1.485-.276.738-.034 1.024-.044 2.515-.045v.002zm4.988 1.328a.96.96 0 1 0 0 1.92.96.96 0 0 0 0-1.92zm-4.27 1.122a4.109 4.109 0 1 0 0 8.217
                                4.109 4.109 0 0 0 0-8.217zm0 1.441a2.667 2.667 0 1 1 0 5.334 2.667 2.667 0 0 1 0-5.334z"/>
                            </svg>
                        </a>
					</section>

					<section className="m-2">
                        <a className='footer-linkedin-color' href="#!">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                            className="bi bi-linkedin" viewBox="0 0 16 16">
                                <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175
                                1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0
                                1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327
                                1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216
                                1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0
					...
					<section className="m-2">
                        <a className='footer-github-color' href="#!">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
				...
				<div className="container w-50 p-0 d-flex justify-content-center footer-height">
                    <div className="justify-content-between p-4 d-flex w-75">
						<div>
						...
						<div>
							<a className="text-light" href="">Our address</a>
						</div>
						
						<div>
							<a className="text-light" href="">Tracked products</a>
						</div>
					</div>
				</div>
				
				<div className="container-fluid p-3 text-light bgcolor-copyright">
                    Copyright © 2022 Sprawdzacz cen
				</div>
