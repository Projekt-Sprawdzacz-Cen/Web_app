...
function Footer() {
    return (
            <footer className="text-center" style={{backgroundColor: "rgb(93, 93, 93)", marginTop: "100px"}}>
				...
				<div className="container" style={{width: "900px", height: "200px"}}>
                    <div className="justify-content-center d-flex">
						<div style={{margin: "35px", marginTop: "25px"}}>
							<a className="text-light" href="#" style={{textDecoration: "none"}}>Home</a>
						</div>
						
						<div style={{margin: "35px", marginTop: "25px"}}>
							<a className="text-light" href="" style={{textDecoration: "none"}}>Features</a>
						</div>
						
						<div style={{margin: "35px", marginTop: "25px"}}>
							<a className="text-light" href="" style={{textDecoration: "none"}}>About us</a>
						</div>
						
						<div style={{margin: "35px", marginTop: "25px"}}>
							<a className="text-light" href="" style={{textDecoration: "none"}}>Our address</a>
						</div>
						
						<div style={{margin: "35px", marginTop: "25px"}}>
							<a className="text-light" href="" style={{textDecoration: "none"}}>Tracked products</a>
						</div>
					</div>
				</div>
				
				<div className="container-fluid p-3 text-light" style={{backgroundColor: "rgba(0, 0, 0, 0.2)"}}>
