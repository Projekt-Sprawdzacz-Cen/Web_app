...
const Panel_logowania = () => {
    return (
		<div>
			<div className="container w-25 log-custom-div">

				<h5 className='log-h5'>Zaloguj się na swoje konto:</h5>
				...
				<form className="needs-validation" action="/action_page.php" novalidate>
					...
					<button className="btn btn-light w-100 log-custom-btn" type="submit">Zaloguj się</button>
					
				</form>
				
				<br/>
				<a className="btn btn-success w-100" href="#" role="button">
					<svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" className="log-social bi bi-google"
					viewBox="0 0 16 16" >
				...
				<a className="btn btn-primary w-100" href="#" role="button">
					<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="log-social bi bi-facebook"
					viewBox="0 0 16 16" >
