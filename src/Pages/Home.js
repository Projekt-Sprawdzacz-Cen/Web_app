    ...
    return (
        <div>
			...
			<div className="container w-50 d-flex justify-content-center flex-wrap mt-5">
				...
				<div className="container w-50 mt-30">
					...
					<form className="needs-validation" action="/action_page.php" novalidate>
						...
						<button className="btn btn-light w-100 custom-button" type="submit">Wyszukaj ceny sklepów</button>

					</form>

					<p className='mt-30'>Wyniki:</p>
