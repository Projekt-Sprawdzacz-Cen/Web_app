...
const Panel_logowania = () => {
    return (
		<div className='container-fluid log-mb-footer-434-mt-115 p-0 log-page'>
			<div className="container w-25 log-custom-div">
				...
				<a className="btn btn-success w-100" href="#" role="button">
					...
					className="log-social bi bi-google" viewBox="0 0 16 16" >
				...
				<a className="btn btn-primary w-100" href="#" role="button">
					...
					className="log-social bi bi-facebook" viewBox="0 0 16 16" >
